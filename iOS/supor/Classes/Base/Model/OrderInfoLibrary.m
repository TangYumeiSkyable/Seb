...
+ (void)control:(NSInteger)deviceId msgCode:(NSInteger)msgCode OrderType:(Order)orderType  subDomian:(NSInteger)subDomainId callback:(void (^)(ACDeviceMsg *responseMsg, NSError *error))callback {
    ...
    [ACBindManager sendToDeviceWithOption:ACDeviceCommunicationOptionOnlyCloud SubDomain:[self getSubDomainByID:[NSString stringWithFormat:@"%ld", subDomainId]] physicalDeviceId:[NSString stringWithFormat:@"%li",(long)deviceId] msg:deviceMsg callback:^(ACDeviceMsg *responseMsg, NSError *error) {
