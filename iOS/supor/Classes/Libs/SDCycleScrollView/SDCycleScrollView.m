...
- (void)initialization
{
    ...
    _titleLabelTextFont= [UIFont fontWithName:Regular size:16];
...
//            [cell.imageView sd_setImageWithURL:[NSURL URLWithString:imagePath] placeholderImage:self.placeholderImage];
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(collectionViewWillDisplay:atIndexPath:)]) {
        [self.delegate collectionViewWillDisplay:cell atIndexPath:indexPath];
    }
    return cell;
}
